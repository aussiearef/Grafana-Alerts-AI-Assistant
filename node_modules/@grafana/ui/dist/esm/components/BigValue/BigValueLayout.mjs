...
import { BigValueColorMode, BigValueTextMode, BigValueJustifyMode } from './BigValue.mjs';
import { percentChangeString } from './PercentChange.mjs';
...
class BigValueLayout {
  ...
  renderChart() {
    ...
    if (!sparkline || ((_a = sparkline.y) == null ? undefined : _a.type) !== FieldType.number) {
      return null;
    }
    let fillColor;
    let lineColor;
...
//# sourceMappingURL=BigValueLayout.mjs.map
