...
import { DefaultCell } from './DefaultCell.mjs';
import { getFooterValue } from './FooterRow.mjs';
import { GeoCell } from './GeoCell.mjs';
import { ImageCell } from './ImageCell.mjs';
import { JSONViewCell } from './JSONViewCell.mjs';
import { RowExpander } from './RowExpander.mjs';
...
function getFooterItems(filterFields, values, options, theme2) {
  ...
  return filterFields.map((data, i) => {
    var _a;
    if (((_a = data == null ? undefined : data.field) == null ? undefined : _a.type) !== FieldType.number) {
    ...
    if (options.fields && options.fields.length > 0) {
      const f = options.fields.find((f2) => {
        var _a2;
        return f2 === ((_a2 = data == null ? undefined : data.field) == null ? undefined : _a2.name);
      });
      if (f) {
