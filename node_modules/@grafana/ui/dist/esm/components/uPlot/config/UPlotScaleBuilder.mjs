...
class UPlotScaleBuilder extends PlotConfigBuilder {
  ...
  getConfig() {
    ...
    const distribution = !isTime ? {
      ...
      log: distr === ScaleDistribution.Log || distr === ScaleDistribution.Symlog ? (_a = this.props.log) != null ? _a : 2 : undefined,
      asinh: distr === ScaleDistribution.Symlog ? (_b = this.props.linearThreshold) != null ? _b : 1 : undefined
    } : {};
