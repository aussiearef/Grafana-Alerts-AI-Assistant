...
const preparePlotConfigBuilder = ({
  ...
  const xScaleKey = "x";
  let yScaleKey = "";
  const xFieldAxisPlacement = ((_a = xField.config.custom) == null ? undefined : _a.axisPlacement) !== AxisPlacement.Hidden ? AxisPlacement.Bottom : AxisPlacement.Hidden;
  const xFieldAxisShow = ((_b = xField.config.custom) == null ? undefined : _b.axisPlacement) !== AxisPlacement.Hidden;
  ...
  for (let i = 1; i < frame.fields.length; i++) {
    ...
    if (((_j = (_i = field.config.custom) == null ? undefined : _i.stacking) == null ? undefined : _j.mode) === StackingMode.Percent) {
      ...
      tweakScale(
        {
          ...
          range: ((_n = customConfig.stacking) == null ? undefined : _n.mode) === StackingMode.Percent ? (u, dataMin, dataMax) => {
    ...
    if (customConfig.axisPlacement !== AxisPlacement.Hidden) {
      ...
      if (customConfig.axisColorMode === AxisColorMode.Series) {
        if (colorMode.isByValue && ((_o = field.config.custom) == null ? undefined : _o.gradientMode) === GraphGradientMode.Scheme && colorMode.id === FieldColorModeId.Thresholds) {
    ...
    if ((_r = field.state) == null ? undefined : _r.origin) {
      ...
      if (customConfig.fillBelowTo) {
        const fillBelowToField = frame.fields.find(
          (f) => {
            var _a2;
            return customConfig.fillBelowTo === f.name || customConfig.fillBelowTo === ((_a2 = f.config) == null ? undefined : _a2.displayNameFromDS) || customConfig.fillBelowTo === getFieldDisplayName(f, frame, allFrames);
          }
        );
