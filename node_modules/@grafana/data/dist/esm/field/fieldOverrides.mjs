...
function setFieldConfigDefaults(config, defaults, context) {
  ...
  const defaultBaseStep = ((_a = defaults == null ? undefined : defaults.thresholds) == null ? undefined : _a.mode) === ThresholdsMode.Absolute && ((_b = defaults.thresholds) == null ? undefined : _b.steps.find((step) => step.value === -Infinity));
  if (((_c = config.thresholds) == null ? undefined : _c.mode) === ThresholdsMode.Absolute && !config.thresholds.steps.some((step) => step.value === -Infinity) && defaultBaseStep) {
...
function useFieldOverrides(plugin, fieldConfig, data, timeZone, theme, replace, dataLinkPostProcessor) {
  ...
  const prevSeries = usePrevious(data == null ? undefined : data.series);
  return useMemo(() => {
